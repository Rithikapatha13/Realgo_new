...
const SVGOverlayComponent = ({ projectName, plotDetails, onPlotClick, bounds }) => {
    const map = useMap();
    ...
    if (!PROJECT_MAP_CONFIG[normalizedName]) {
        return (
            <div className="h-[600px] flex flex-col items-center justify-center bg-slate-50 rounded-3xl border-2 border-dashed border-slate-200 p-8 text-center">
                ...
                <p className="text-slate-500 max-w-sm">An interactive SVG layout for "{projectName}" has not been assigned to this project yet.</p>
