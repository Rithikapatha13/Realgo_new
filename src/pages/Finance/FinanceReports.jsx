...
import {
    PieChart, BarChart2, Briefcase, ArrowLeft, FileText, Printer, Download, Loader2
} from "lucide-react";
...
const FinanceReports = () => {
    ...
    return (
        <div className="p-6 bg-slate-50/50 min-h-screen">
            ...
            {/* Tabs */}
            <div className="flex bg-white p-1 rounded-xl border border-slate-200 mb-8 w-fit shadow-sm overflow-x-auto no-scrollbar max-w-full">
                {tabs.map((tab) => (
                    <button
                        key={tab.id}
...
const LedgerStatementReport = ({ filters }) => {
    ...
    if (isLoading) return <div className="py-20 text-center">
        <Loader2 className="animate-spin inline text-indigo-600" /></div>;
