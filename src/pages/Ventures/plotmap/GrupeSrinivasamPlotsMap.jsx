...
const GrupeSrinivasamPlotsMap = () => {
    const navigate = useNavigate();
    const projectId = "6de8812b-0304-46b5-8579-7f6d778d62e0";
    ...
    return (
        <div className="p-6 space-y-6 bg-[#fdfdfd] min-h-screen">
            <div className="flex items-center gap-4 mb-2">
                ...
                <div>
                    <h1 className="text-2xl font-black text-slate-900 tracking-tight">Srinivasapuram</h1>
                </div>
            </div>
...
export default GrupeSrinivasamPlotsMap;
